    ...
    <div className="min-h-screen text-white px-6 py-10 flex flex-col items-center">
      <div className="w-full max-w-5xl">
        ...
        {estados.map((estado) => (
            ...
            key={estado}
            value={estado}
            className="text-white bg-[#1e293b] hover:bg-[#374151]" // Fondo oscuro y texto blanco
            >
            {estado}
            </option>
        ))}
            ...
            >
                ...
                {isLoadingAccounts ? (
                    ...
                    <div className="space-y-2">
                        ...
                        <select
                        value={investmentData.numeroCuenta}
                        onChange={(e) =>
                            setInvestmentData({
                            ...investmentData,
                        ...
                        <option value="">Seleccione</option>
                        {accounts.map((acc) => (
                            <option key={acc.uid} value={acc.numeroCuenta}>
